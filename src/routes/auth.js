...
// controllers
const { requestRefreshToken, login, loginAdmin, register, logout, verifyRegister } = require('../controllers/auth')
...
router.post('/login/admin', checkLogin, logValidation, loginAdmin)
